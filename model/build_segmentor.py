...
from model.SeRankDet import SeRankDet

__all__ = ["Model", "SeRankDet"]
...
class Model(nn.Module):
    def __init__(self, cfg):
        ...
        backbone_name = (
            cfg.model["backbone"]["type"] if cfg.model["backbone"]["type"] else None
        )
        ...
        self.backbone = (
            backbone_class(**cfg.model["backbone"]) if backbone_name else None
        )
